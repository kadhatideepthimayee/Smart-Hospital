...
def generate_report():
    ...
    ws_log.cell(row=1, column=1, value="MedPlus Selenium Web Execution Log Console Output").font = Font(name="Segoe UI", size=11, bold=True, color="1B365D")
    log_messages = [
        "[INFO] 2026-08-20T22:00:00.001Z - Initializing Selenium WebDriver...",
        "[INFO] 2026-08-20T22:00:01.554Z - Starting Headless Chrome Web Browser Instance...",
        "[INFO] 2026-08-20T22:00:03.109Z - Connecting to Local Server at http://127.0.0.1:5000...",
        "[INFO] 2026-08-20T22:00:04.225Z - Loading MedPlus Admin Portal login UI...",
        "[INFO] 2026-08-20T22:00:05.101Z - Starting Web Selenium Test Execution Suite (400 Test Cases)...",
    ]
    ...
    for i in range(1, 401):
        row_num = 7 + i
        ws_log.cell(row=row_num, column=1, value=f"[TEST] TC{i:03d} - Running web test case... [RESULT: PASS] ({random.randint(15, 45)}ms)").font = Font(name="Consolas", size=9, color="2E7D32")
