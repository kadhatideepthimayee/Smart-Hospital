    ...
    <div className="max-w-xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <Card className="p-7 rounded-3xl" hoverEffect={false}>
        <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-5 select-none">
          <div className="w-16 h-16 rounded-2xl bg-medical-blue-50/70 border border-medical-blue-100/50 text-medical-blue-600 flex items-center justify-center font-black shadow-xs">
            <Shield size={28} />
          </div>
          <div>
        ...
        <form onSubmit={handleUpdate} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className="w-full pl-11 pr-4 py-2.5 rounded-xl border border-slate-200 text-sm font-semibold focus:ring-4 focus:ring-medical-blue-500/10 focus:border-medical-blue-500 outline-none transition-all duration-200 bg-white"
                value={fullName}
